...
public class LumenVulkanModIntegration {
    ...
    private static void initReflection() throws Exception {
        ...
        switchCtor = switchOptClass.getConstructor(Component.class, Consumer.class, Supplier.class);
        rangeCtor = rangeOptClass.getConstructor(Component.class, double.class, double.class, double.class, double.class, Consumer.class, Supplier.class);
    ...
    private static void registerEntry() throws Exception {
        ...
        var entryCtor = entryClass.getConstructor(
                Component.class, Supplier.class, Supplier.class, Runnable.class);
